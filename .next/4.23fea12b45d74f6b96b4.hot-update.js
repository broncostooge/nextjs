...
var Index = function Index(props) {
  ...
  }, "Steam Games for ", props.user), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("ul", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8
    }
...
__WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee() {
  var res, data, userRes, userData, listOfGames, listOfUsers;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 11:
          ...
          listOfGames = [];
          listOfUsers = [];
          console.log(userData.response.players);
          ...
          userData.response.players.map(function (player, index) {
            return listOfUsers.push({
              username: player.personaname
            });
          });
          return _context.abrupt("return", {
            listOfGames: listOfGames,
            user: userData.response.players.personaname
          });
...
//# sourceMappingURL=4.23fea12b45d74f6b96b4.hot-update.js.map
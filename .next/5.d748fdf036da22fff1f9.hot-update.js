      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = context.query.id;
            _context.next = 3;
            return __WEBPACK_IMPORTED_MODULE_3_isomorphic_unfetch___default()('https://store.steampowered.com/api/appdetails/?appids=' + id);
          ...
          case 6:
            game = _context.sent;
            console.log;
            console.log('Fetched show:' + game.data);
...
//# sourceMappingURL=5.d748fdf036da22fff1f9.hot-update.js.map